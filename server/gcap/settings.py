"""
Django settings for gcap project.
...
SECRET_KEY = 'django-insecure-+xoei1privsyqkydnk_q28mp1r3b3+8y6o%^zvmd_+(#4fzwdz'
...
WSGI_APPLICATION = 'gcap.wsgi.application'
